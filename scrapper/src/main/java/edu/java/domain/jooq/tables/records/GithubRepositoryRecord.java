...
public class GithubRepositoryRecord extends UpdatableRecordImpl<GithubRepositoryRecord> implements Record5<Long, Long, String, Integer, OffsetDateTime> {
    ...
    public GithubRepositoryRecord(@NotNull Long id, @Nullable Long linkId, @NotNull String fullName, @NotNull Integer forksCount, @Nullable OffsetDateTime updatedAt) {
        super(GithubRepository.GITHUB_REPOSITORY);
