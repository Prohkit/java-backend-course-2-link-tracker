...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record5<Long, String, OffsetDateTime, OffsetDateTime, OffsetDateTime> {
     ...
     */
    public void setLastUpdateCheckTime(@Nullable OffsetDateTime value) {
        set(3, value);
    }
    ...
    public Field<OffsetDateTime> field4() {
        return Link.LINK.LAST_UPDATE_CHECK_TIME;
    }

    @Override
    @NotNull
    public Field<OffsetDateTime> field5() {
        return Link.LINK.LAST_MODIFIED_TIME;
    }
    ...
    public LinkRecord(@Nullable Long id, @NotNull String url, @Nullable OffsetDateTime createdAt, @Nullable OffsetDateTime lastUpdateCheckTime, @Nullable OffsetDateTime lastModifiedTime) {
        super(Link.LINK);

        setId(id);
        setUrl(url);
        setCreatedAt(createdAt);
        setLastUpdateCheckTime(lastUpdateCheckTime);
    ...
    public LinkRecord(edu.java.domain.jooq.tables.pojos.Link value) {
        ...
        if (value != null) {
            ...
            setLastUpdateCheckTime(value.getLastUpdateCheckTime());
