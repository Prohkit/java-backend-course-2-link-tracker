...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>LINK.LAST_UPDATE_CHECK_TIME</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_UPDATE_CHECK_TIME = createField(DSL.name("LAST_UPDATE_CHECK_TIME"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field(DSL.raw("LOCALTIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>LINK.LAST_MODIFIED_TIME</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_MODIFIED_TIME = createField(DSL.name("LAST_MODIFIED_TIME"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
